...
void QueryCvarProvider::FixQueryCvarCookie()
{
	...
	{
		if (*m_engine_cvar_cookie < 0 || *m_engine_cvar_cookie == std::numeric_limits<SourceSdk::QueryCvarCookie_t>::max())
		{
...
void QueryCvarProvider::Init()
{
	...
	CSGO
	dll :
	VEngineServer::StartQueryCvarValue -> jmp
	...
	so :
	VEngineServer::StartQueryCvarValue -> jmp -> Engine.SendCvarValueQueryToClient
